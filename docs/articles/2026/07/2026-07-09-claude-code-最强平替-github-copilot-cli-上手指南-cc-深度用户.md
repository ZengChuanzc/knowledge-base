...
category: 技术热点
source: 开源中国
description: Claude Code 大规模封禁后，GitHub Copilot CLI 凭借稳定的 API、强大的代码生成能力和与 GitHub 生态的无缝集成，成为 Java 后端开发者最值得关注的 AI 编程替代方案。
---
...
Claude Code 大规模封禁后，GitHub Copilot CLI 凭借稳定的 API、强大的代码生成能力和与 GitHub 生态的无缝集成，成为 Java 后端开发者最值得关注的 AI 编程替代方案。
...
**有一定关联。** Spring AI 是 Spring 生态中用于集成 AI 服务的框架，它本身不提供代码生成能力，但可以与 Copilot CLI 互补。例如，你可以用 Copilot CLI 生成 Spring AI 的 `ChatClient` 或 `EmbeddingClient` 配置代码，然后手动调整。未来，Spring AI 可能会内置类似 Copilot 的代码补全功能。
